...
class ProductThanhLyList extends StatelessWidget {
  final List<Product> products;

  const ProductThanhLyList({Key key, this.products}) : super(key: key);
...
class ProductThanhLyPage extends StatefulWidget {
  @override
  ProductThanhLyState createState() => ProductThanhLyState();
}

class ProductThanhLyState extends State<ProductThanhLyPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder(
          future: fetchThanhLyProducts(http.Client()),
          builder: (context, snapshot) {
            ...
            return snapshot.hasData
                ? ProductThanhLyList(products: snapshot.data)
                : Center(
